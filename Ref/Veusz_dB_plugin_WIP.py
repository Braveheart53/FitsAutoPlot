...
class dBLinearAvgByTagPlugin(_ConsoleMixin, _MathHelpers, DatasetPlugin):
    ...
    def updateDatasets(self, fields, helper):
        ...
        self.tag_map = self.tagProcessing(helper)  # Call as instance method
        ...
        for tag, group in self.tag_map.items():
            ...
            try:
                ...
                datasets = [helper.getDataset(ds_name, dimensions=1) for ds_name in group]
                ...
                self._log(helper, f"[ByTag] wrote '{tag}_dB_avg' & '{tag}_lin_avg'")
