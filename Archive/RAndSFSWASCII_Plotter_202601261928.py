...
class ProcessingConfig:
    ...
    chunk_size: int = 1000
    # NEW: Added plotting and auto-save options
...
class EnhancedMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(100, 100, 800, 700)  # Increased height for new options
    ...
    # NEW: Auto-save configuration handlers
...
class VZPlotRnS:
    ...
    # NEW: Setup automatic save path based on configuration
    ...
    def _create_average_datasets(self, base_name: str):
        ...
        # NEW: Only plot average if in appropriate mode
