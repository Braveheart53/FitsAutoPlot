...
FIXED VERSION (2026-02-03) - COMPLETE:
...
- Logging checkbox and log file creation for missing data
- Overlay plot of all imported data
- Individual plots for each file
- Datasets tagged with filename
- Dataset naming: [filename]_[column name]
    ...
    def set_logging(self, enable: bool, log_path: str = None):
        ...
        if enable and log_path:
            try:
                ...
                self.log_file.write(f"CSV/TSV AutoPlot Log - {timestamp}\n")
...
class CSVAutoPlotMainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        generate_btn.setStyleSheet("background-color: #4CAF50; color: white; font-weight: bold; padding: 8px;")
    ...
    def generate_plots(self):
        ...
        try:
            ...
            if self.enable_logging_checkbox.isChecked():
                ...
                log_path = f"CSV_AutoPlot_Log_{timestamp}.txt"
