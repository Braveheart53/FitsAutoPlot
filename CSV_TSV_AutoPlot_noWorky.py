...
FIXED VERSION - Corrected Veusz API Syntax:
- Line 512: Fixed line_style mapping (matplotlib -> Veusz format)
- Line 520: Fixed graph properties (title, xlabel, ylabel, xLog, yLog, showLegend)
- Used correct Veusz API syntax from ATR_AutoPlot.py as reference
...
class PlotConfig:
    ...
    marker_style: str = "o"  # Matplotlib style
...
class VeuszPlotter:
    ...
    # Mapping from matplotlib line styles to Veusz line styles
    LINE_STYLE_MAP = {
        '-': 'solid',
        '--': 'dashed',
        '-.': 'dashdot',
    ...
    # Mapping from matplotlib markers to Veusz markers
    MARKER_STYLE_MAP = {
        'o': 'circle',
        's': 'square',
        '^': 'triangle',
    ...
    def create_xy_plot(self, df: pd.DataFrame, x_column: str, y_columns: List[str],
        ...
        try:
            ...
            for idx, y_col in enumerate(y_columns):
                ...
                # FIXED: Convert matplotlib line style to Veusz line style
                veusz_line_style = self.LINE_STYLE_MAP.get(plot_config.line_style, 'solid')
                
                # FIXED: Convert matplotlib marker to Veusz marker
