    ...
    def create_overlay_and_individual_plots(
        ...
        try:
            ...
            for filename, df in data_dict.items():
                ...
                file_page = self.doc.Root.Add('page', name=f'Page_{base_filename}')
                file_page.notes.val = notes_text  # Store metadata in page notes
                
                # Create graph for this file
                file_graph = file_page.Add('graph', name=f'Graph_{base_filename}')
            ...
            self.log_message(f"Created {total_pages} pages: 1 overlay + {num_files} individual file pages")
